#!/usr/bin/env python3
from pipeline_SS_TV_Siemens import create_pipeline_SS_TV, RunMode, BrainExtractMethod
import os
import argparse
...
if __name__ == "__main__":
    ...
    parser.add_argument("--run_mode", choices=RunMode.__members__, default='MCR', help=argparse.SUPPRESS)
